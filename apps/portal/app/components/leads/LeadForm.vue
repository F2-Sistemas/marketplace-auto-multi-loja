...
<template>
  <div class="border border-neutral-150 bg-white rounded-card overflow-hidden shadow-sm p-6 space-y-4">
    <!-- Success visual block -->
    <div v-if="success" class="text-center py-6 space-y-4 animate-in fade-in zoom-in-95">
      <div class="w-12 h-12 rounded-full bg-emerald-50 text-emerald-500 flex items-center justify-center mx-auto border border-emerald-100">
      ...
      <div class="space-y-1">
        ...
        <p class="text-xs text-neutral-500 font-semibold max-w-xs mx-auto">
      ...
      <div v-if="storePhone" class="pt-4 space-y-2">
        <p class="text-[10px] font-bold text-neutral-400 uppercase tracking-wider">Ou converse agora mesmo</p>
        <UiButton
          variant="primary"
          size="md"
          class="w-full !bg-emerald-600 hover:!bg-emerald-700 !border-emerald-600 focus:ring-emerald-100 shadow-sm shadow-emerald-600/10 font-bold"
    ...
    <form v-else @submit.prevent="handleSubmit" class="space-y-4">
      ...
      <div class="space-y-3.5">
        <!-- Name -->
        <div class="space-y-1">
          <label for="lead-name" class="text-[10px] font-bold text-neutral-400 uppercase tracking-wider">
            Nome Completo
          </label>
          <UiInput
            v-model="name"
        ...
        <!-- Email -->
        <div class="space-y-1">
          <label for="lead-email" class="text-[10px] font-bold text-neutral-400 uppercase tracking-wider">
            E-mail
          </label>
          <UiInput
            v-model="email"
        ...
        <!-- Phone -->
        <div class="space-y-1">
          <label for="lead-phone" class="text-[10px] font-bold text-neutral-400 uppercase tracking-wider">
            Telefone / Celular
          </label>
          <UiInput
            v-model="phone"
        ...
        <!-- Message -->
        <div class="space-y-1">
          <label for="lead-message" class="text-[10px] font-bold text-neutral-400 uppercase tracking-wider">
            Mensagem
          </label>
          <textarea
            v-model="message"
      ...
      <div class="space-y-2 pt-2">
        <UiButton
          ...
          variant="primary"
          size="md"
          class="w-full shadow-sm shadow-brand-500/10 font-bold"
          :loading="loading"
        >
        ...
        <UiButton
          ...
          variant="outline"
          size="md"
          class="w-full hover:bg-emerald-50/50 hover:border-emerald-200 hover:text-emerald-700 font-bold"
          @click="handleWhatsApp"
        >
          <template #icon>
            <iconify-icon icon="tabler:brand-whatsapp" class="text-base text-emerald-500 group-hover:text-emerald-700"></iconify-icon>
          </template>
