...
const classes = computed(() => {
    const base =
        'inline-flex items-center justify-center font-normal transition-all duration-180 ease-[cubic-bezier(0.2,0,0,1)] select-none outline-none active:scale-[0.98]';

    const variants = {
        primary: 'bg-brand-500 text-white hover:bg-brand-600 focus:ring-2 focus:ring-brand-200 focus:ring-offset-1',
        secondary:
            'bg-neutral-900 text-white hover:bg-neutral-800 focus:ring-2 focus:ring-neutral-200 focus:ring-offset-1',
        outline:
            'border border-neutral-200 bg-white text-neutral-700 hover:bg-neutral-50 hover:border-neutral-300 focus:ring-2 focus:ring-neutral-100',
...
<template>
    <component
        ...
        :to="to"
        :href="href"
        :type="isComponent === 'button' ? type : undefined"
