...
const selectClasses = computed(() => {
  const base = 'w-full px-4 h-10 bg-white border text-sm text-neutral-800 outline-none rounded-input appearance-none cursor-pointer transition-all duration-150 pr-10';
  
  if (props.disabled) {
    return `${base} border-neutral-150 bg-neutral-50 text-neutral-400 cursor-not-allowed`;
  }
