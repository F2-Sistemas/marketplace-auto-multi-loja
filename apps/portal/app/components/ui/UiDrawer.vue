...
<template>
    <Teleport to="body">
        <div v-if="isOpen" class="fixed inset-0 z-50 flex justify-end" role="dialog" aria-modal="true">
            ...
            >
                <!-- Header -->
                <div class="px-6 h-16 border-b border-neutral-200 flex items-center justify-between">
                    <h3 class="font-semibold text-base text-neutral-800">{{ title }}</h3>
                    <button
                        @click="close"
                ...
                <!-- Footer (Optional) -->
                <div v-if="$slots.footer" class="p-6 border-t border-neutral-200 bg-neutral-50/50">
