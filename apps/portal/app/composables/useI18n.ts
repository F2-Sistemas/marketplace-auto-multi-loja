...
const ptBR = {
  ...
  heroDesc: 'Explore o estoque integrado de dezenas de lojas qualificadas, encontre o veículo perfeito com segurança e fale direto com o consultor.',
  hero: {
    title: 'A maior rede de revendas premium do Brasil',
    subtitle: 'Explore o estoque integrado de dezenas de lojas qualificadas, encontre o veículo perfeito com segurança e fale direto com o consultor.'
  },
  ...
  search: {
    ...
    catalogSubtitle: 'Encontre o veículo perfeito entre as centenas de ofertas exclusivas das melhores concessionárias da região.',
