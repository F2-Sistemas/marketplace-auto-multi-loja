...
<template>
  <div class="min-h-screen bg-neutral-50 flex flex-col items-center justify-center p-6 text-center font-sans">
    <div class="space-y-4 max-w-sm">
      <div class="w-12 h-12 rounded-lg bg-brand-500 flex items-center justify-center text-white mx-auto shadow-md animate-pulse">
        <iconify-icon icon="tabler:arrow-up-right" class="text-2xl"></iconify-icon>
      </div>
      <h3 class="text-lg font-bold text-neutral-800">Redirecionando...</h3>
      <p class="text-xs text-neutral-400 font-semibold leading-relaxed">
