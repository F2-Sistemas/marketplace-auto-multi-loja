    ...
    return [
      {
        ...
        slug: 'autocar-natal',
        logo: 'https://images.unsplash.com/photo-1560179707-f14e90ef3623?q=80&w=300&auto=format&fit=crop',
        description: 'Sua concessionária autorizada em Natal, RN. Ofertas exclusivas de veículos novos e seminovos multimarcas.',
        phone: '(84) 3222-3000',
      ...
      },
      {
        ...
        slug: 'sp-veiculos',
        logo: 'https://images.unsplash.com/photo-1560179707-f14e90ef3623?q=80&w=300&auto=format&fit=crop',
        description: 'Líder em vendas de seminovos importados e nacionais. Garantia e a melhor avaliação do seu usado na troca.',
        phone: '(11) 3888-4000',
      ...
      },
      {
        ...
        slug: 'loja01',
        logo: 'https://images.unsplash.com/photo-1560179707-f14e90ef3623?q=80&w=300&auto=format&fit=crop',
        description: 'Veículos com laudo cautelar aprovado e procedência garantida. Credenciada com as principais financeiras do mercado.',
        phone: '(84) 99999-9999',
      ...
      },
      {
        ...
        slug: 'tauro-motors',
        logo: 'https://images.unsplash.com/photo-1560179707-f14e90ef3623?q=80&w=300&auto=format&fit=crop',
        description: 'Concessionária referência em picapes e utilitários esportivos (SUV). Venha fazer um test-drive!',
        phone: '(84) 97777-7777',
...
<template>
  <div class="container max-w-7xl mx-auto px-4 md:px-6 py-6 space-y-6">
    ...
    <div class="space-y-2">
      ...
      <p class="text-sm font-semibold text-neutral-500 max-w-2xl leading-relaxed">
        Conheça as melhores concessionárias de automóveis da região. Encontre a loja parceira mais próxima e garanta o seu próximo carro com total segurança e garantia.
      </p>
    </div>
    ...
    <div v-if="pending" class="py-16 flex flex-col items-center justify-center space-y-4">
      ...
      <p class="text-sm font-semibold text-neutral-400">Localizando concessionárias...</p>
    </div>
