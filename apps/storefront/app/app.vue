...
// Pre-defined tenant stores (with fallback metadata)
...
// Current resolved store details with API fallbacks
const currentStore = computed(() => {
    const t = tenantResponse.value;
    const fallback = tenants[currentTenantKey.value];
...
<template>
    <div class="min-h-screen bg-slate-950 text-slate-100 font-['Outfit'] antialiased">
        ...
        <div
            class="fixed bottom-6 right-6 z-50 bg-slate-900/90 border border-slate-800 backdrop-blur-xl p-4 rounded-2xl shadow-2xl max-w-xs"
        >
            <span
                class="text-[10px] font-extrabold uppercase text-indigo-400 tracking-wider flex items-center gap-1 mb-2"
            >
        ...
        <header class="sticky top-0 z-40 bg-slate-950/90 backdrop-blur-xl border-b border-slate-850">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    <div
                        :class="[
                            'w-10 h-10 rounded-xl bg-gradient-to-tr flex items-center justify-center text-white shadow-lg',
                ...
                <div class="hidden lg:flex items-center gap-6">
                    <div class="flex items-center gap-2">
                        ...
                        <div>
                            <span class="text-[10px] text-slate-500 block uppercase font-bold leading-none">
                                Ligue agora
                            </span>
        ...
        <section class="relative py-24 overflow-hidden border-b border-slate-900">
            <div
                class="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(99,102,241,0.08),transparent_50%)]"
            ></div>

            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                <span
                    class="px-3 py-1 rounded-full bg-slate-900 border border-slate-800 text-slate-400 text-xs font-bold uppercase tracking-wider"
                >
                ...
                <h1 class="mt-6 text-4xl sm:text-6xl font-extrabold tracking-tight text-white">
                    Bem-vindo à
                    <br />
                    <span :class="['bg-gradient-to-r bg-clip-text text-transparent', currentStore.primaryColor]">
                        {{ currentStore.name }}
                    </span>
                </h1>
        ...
        <section class="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between mb-8 border-b border-slate-900 pb-4">
                ...
                <span class="text-xs text-slate-400">
                    Encontrados:
                    <strong class="text-white">{{ filteredVehicles.length }}</strong>
                </span>
            </div>
                    ...
                    <div class="p-6 flex-1 flex flex-col justify-between">
                        <div>
                            ...
                            <div class="flex flex-wrap gap-2 mt-4">
                                <span
                                    class="flex items-center gap-1 px-2.5 py-1 rounded-lg bg-slate-950 text-[11px] text-slate-400 border border-slate-850"
                                >
                        ...
                        <div class="mt-6 pt-5 border-t border-slate-900 flex items-center justify-between">
                            <div>
                                <span class="text-[10px] text-slate-500 block uppercase tracking-wider font-semibold">
                                    Preço Especial
                                </span>
            ...
            <div
                ...
                class="mt-16 text-center py-20 bg-slate-900/20 rounded-3xl border border-slate-900"
            >
        ...
        >
            <div
                class="bg-slate-900 border border-slate-800 max-w-2xl w-full rounded-3xl overflow-hidden shadow-2xl relative animate-in fade-in zoom-in duration-300"
            >
                <button
                    @click="closeDetails"
                ...
                <div class="p-6 md:p-8 space-y-6">
                    <!-- Quick Specs Grid -->
                    <div
                        class="grid grid-cols-2 md:grid-cols-4 gap-4 bg-slate-950/60 p-4 rounded-2xl border border-slate-850"
                    >
                        <div>
                    ...
                    <div class="border-t border-slate-800 pt-6">
                        ...
                        >
                            ...
                            <span class="text-sm font-semibold">
                                Redirecionando para o consultor da {{ currentStore.name }} no WhatsApp...
                            </span>
                        </div>
