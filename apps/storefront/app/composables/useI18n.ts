...
const translations: Record<string, Record<string, string>> = {
    'pt-BR': {
        ...
        'theme.layout.label': 'Estilo de Lista de Veículos',
        'theme.button.saving': 'Salvando...',
        'theme.button.save': 'Salvar Tema',
        'theme.layout.minimalist': 'Minimalista (Padrão)',
        'theme.layout.advanced': 'Avançado (Detalhado)',
        'theme.layout.grid': 'Grade',
        'theme.layout.list': 'Lista',
    },
};
