...
const ptBR = {
  ...
  dashboard: {
    ...
    supportDesc: 'Cada nova loja cadastrada gera automaticamente um banco de dados isolado logicamente, sitemaps configurados no Redis e um site exclusivo no subdomínio correspondente.',
