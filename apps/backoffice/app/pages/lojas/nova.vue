    ...
    <div class="max-w-2xl mx-auto animate-fadeIn">
        <UiCard class="relative overflow-hidden">
            ...
            >
                ...
                >
                    <div
                        class="w-16 h-16 rounded-full bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-400 mb-4 animate-bounce"
                    >
            ...
            <form @submit.prevent="handleCreateStore" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="flex">
                        ...
                        />
                        <span
                            class="bg-slate-900 border-y border-r border-slate-800 rounded-r-lg px-4 py-2.5 text-xs text-slate-400 font-semibold flex items-center select-none"
                        >
                            .rederevenda.com
                        </span>
                    </div>
                ...
                <!-- SELECT PLAN -->
                <UiSelect v-model="newStore.plan" :label="t('wizard.fields.plan')" :options="plans" />
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                        ...
                        >
                            ...
                            <span class="text-xs font-semibold text-slate-200 leading-none">{{ color.label }}</span>
                        </button>
                    </div>
                </div>
