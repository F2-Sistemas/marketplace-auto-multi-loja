            ...
            <div>
                ...
                <div class="p-6 flex items-center gap-3 border-b border-slate-800">
                    ...
                    <div>
                        ...
                        <span
                            class="text-[9px] uppercase font-semibold text-slate-400 block tracking-widest leading-none"
                        >
                            {{ t('appSub') }}
                        </span>
                    </div>
                ...
                <nav class="p-4 space-y-1.5">
                    <div class="px-4 pt-2 pb-2 text-[10px] uppercase font-semibold text-slate-500 tracking-wider">
                    ...
                    >
                        ...
                        <span>{{ t('navigation.globalSupport') }}</span>
                    </NuxtLink>

                    <div class="px-4 pt-6 pb-2 text-[10px] uppercase font-semibold text-slate-500 tracking-wider">
                        Visão Lojista
                    </div>
                    <NuxtLink
                        to="/chamados"
                    ...
                    >
                        <iconify-icon icon="tabler:ticket" class="text-lg"></iconify-icon>
                        <span>{{ t('navigation.myTickets') }}</span>
                    </NuxtLink>
